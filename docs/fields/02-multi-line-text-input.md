...
| Property                                            | Description                       |
| :-------------------------------------------------- | :-------------------------------- |
| [text](./24-general-properties.md)                  | Localized label text of the field. Shown in the UI and the PDF. |
| [uiHide](./24-general-properties.md)                | Setting this to `true` hides the label in the UI. |
| [pdfHide](./24-general-properties.md)               | Setting this to `true` hides the label in the PDF. |
| [pdfTextSize](./24-general-properties.md)           | Text size of the label in the PDF. |
| [pdfTextColor](./24-general-properties.md)          | Text color of the label in the PDF. |
...
| [pdfHide](./24-general-properties.md)                  | Setting this to `true` hides the value in the PDF.                                              |
| [pdfTextSize](./24-general-properties.md)              | Text size of the value in the PDF.                                                              |
| [pdfTextColor](./24-general-properties.md)             | Text color of the value in the PDF.                                                             |
| [pdfStartInNewLine](./24-general-properties.md)        | Setting this to `true` will show the field value in the PDF in a separate line below the label. |
| [validators.maxCharacters](./24-general-properties.md) | Maximum number of characters for the input value to be valid.                                   |
| [validators.minCharacters](./24-general-properties.md) | Minimum number of characters for the input value to be valid.                                   |
